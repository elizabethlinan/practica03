...
<h1>Registra Plato</h1>
	...
	<form action="registraPlato" id="id_form" method="post"> 
			...
			<div class="form-group">
				...
				<input class="form-control" id="id_maxima" name="restaurante" placeholder="Ingrese restaurante" type="text"/>
			</div>
			<div class="form-group">
				<label class="control-label" for="id_minima">FechaVencimiento</label>
				<input class="form-control" id="id_minima" name="fechaVencimiento" placeholder="Ingrese fechaVencimiento" type="text"/>
			</div>
			<div class="form-group">
				<label class="control-label" for="id_minima">Ingredientes</label>
				<input class="form-control" id="id_minima" name="ingredientes" placeholder="Ingrese ingredientes" type="text"/>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<button type="submit" class="btn btn-primary" >RegistraPlato</button>
			</div>
	</form>
</div>
