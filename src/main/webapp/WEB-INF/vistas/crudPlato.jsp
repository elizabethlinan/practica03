  	 ...
  	 <div class="modal fade" id="idModalRegistra" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_registra" accept-charset="UTF-8" action="insertaActualizaPlato" class="form-horizontal"     method="post">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_precio" name="precio" placeholder="Ingrese el número de hombres" type="text" />
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_stock">Stock</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_stock" name="stock" placeholder="Ingrese el número de mujeres" type="text" />
		                                        </div>
		                                    </div>		   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_restaurante">Restaurante</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_restaurante" name="restaurante" placeholder="Ingrese la edad máxima" type="text"/>
		                                        </div>
		                                    </div>   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_fechaVencimiento">Fecha Vencimiento</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_fechaVencimiento" name="fechaVencimiento" placeholder="Ingrese la edad mínima" type="text"/>
		                                        </div>
		                                    </div>   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_ingredientes">Ingredientes</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_ingredientes" name="ingredientes" placeholder="Ingrese la edad mínima" type="text" />
		                                        </div>
		                                    </div>  
		                                    <div class="form-group">
		 ...
		 <div class="modal fade" id="idModalActualiza" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action="insertaActualizaPlato" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_num_precio" name="precio" placeholder="Ingrese el número de hombres" type="text"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_restaurante">Restaurante</label>
		                                        <div class="col-lg-5">
		                                    ...
		                                    <div class="form-group">
		                                     ...
		                                     <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_ingredientes">Ingredientes</label>
		                                        <div class="col-lg-5">
...
<script type="text/javascript">
	$('#id_form_registra').bootstrapValidator({
        ...
        fields: {
            ...
            "restaurante": {
        		selector : '#id_reg_restaurante',
                validators: {
                	notEmpty: {
                        message: 'restaurante es un campo obligatorio'
                    }
                }
            },
            "fechaVencimiento": {
            ...
            "ingredientes": {
        		selector : '#id_reg_ingredientes',
                validators: {
                	notEmpty: {
                        message: 'ingredientes es un campo obligatorio'
                    }
                }
            },
            "pais.idPais": {
	...
	$('#id_form_actualiza').bootstrapValidator({
        ...
        fields: {
            ...
            "restaurante": {
                ...
                validators: {
                	notEmpty: {
                        message: 'El restaurante es un campo obligatorio'
                    }
                }
            },
            "fechaVencimiento": {
            ...
            "ingredientes": {
                ...
                validators: {
                	notEmpty: {
                        message: 'El ingredientes un campo obligatorio'
                    }
                }
            },
